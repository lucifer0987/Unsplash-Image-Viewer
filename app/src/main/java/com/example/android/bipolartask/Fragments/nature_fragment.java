...
import com.example.android.bipolartask.MainActivity;
...
public class nature_fragment extends Fragment  implements LoaderManager.LoaderCallbacks<List<Image>> {
    ...
    private String STRING_URL =
            "https://api.unsplash.com/collections/1580860/photos?client_id=" + client_id + "&&page=1&&per_page=30";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv_grid = view.findViewById(R.id.rv_nature);
